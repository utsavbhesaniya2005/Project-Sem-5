...
<html lang="en">
    ...
    <body>
        ...
        <main>
            ...
            <!-- Special Recipe -->
            <section class="s-recipe d-flex align-items-center mt-100">
                <div class="container">
                    <div class="row">
            ...
            <!-- Real Taste -->
            <section class="r-taste mt-100 d-flex align-items-center">
                <div class="container">
